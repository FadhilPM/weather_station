#cleanup script to get rid of spaces and convert to proper csv format
import pandas as pd
import matplotlib.dates
from datetime import datetime

df = pd.read_csv('709_uncleaned.csv',sep='\s+',header=None);
...
df[5] = 0.9162 * df[5] + 5.0965
#df[1].to_csv('517_halfhourly_cleaned.csv',header=None);
df.to_csv('709_cleaned.csv',header=['Hour', 'Days_since_UNIX', 'PM2.5', 'PM10', 'Temp/K', 'Humidity']);
